...
export const StaffModule = () => {
    ...
    const handleScanResult = (data: string) => {
        console.log('[StaffModule] Raw Scan Data:', data); // DEBUG LOG
        ...
        try {
            ...
            console.log('[StaffModule] Scan data is not JSON, using raw string');
        }

        console.log('[StaffModule] Looking for Asset ID:', assetId); // DEBUG LOG
        console.log('[StaffModule] Available Assets:', assets.map(a => a.id)); // DEBUG LOG

        const asset = assets.find(a => a.id === assetId.trim() || a.serialNumber === assetId.trim());

        if (asset) {
            console.log('[StaffModule] Asset Found:', asset); // DEBUG LOG
            setSelectedAsset(asset);
            setView('DETAIL');
            setScanInput('');
        } else {
            console.warn('[StaffModule] Asset NOT found'); // DEBUG LOG
